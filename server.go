...
func createRouter(s *Server) *mux.Router {
	...
	m := map[string]map[string]RequestHandler{
		...
		"POST": {
			...
			"/objectstores/{objectstore-uuid}/volumes/{volume-uuid}/add":                               s.doObjectStoreAddVolume,
			"/objectstores/{objectstore-uuid}/volumes/{volume-uuid}/snapshots/{snapshot-uuid}/backup":  s.doSnapshotBackup,
			"/objectstores/{objectstore-uuid}/volumes/{volume-uuid}/snapshots/{snapshot-uuid}/restore": s.doSnapshotRestore,
		...
		"DELETE": {
			...
			"/objectstores/{objectstore-uuid}/volumes/{volume-uuid}/":                           s.doObjectStoreRemoveVolume,
			"/objectstores/{objectstore-uuid}/volumes/{volume-uuid}/snapshots/{snapshot-uuid}/": s.doSnapshotRemove,
