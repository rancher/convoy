...
func createRouter(s *Server) *mux.Router {
	...
	m := map[string]map[string]RequestHandler{
		"GET": {
			...
			"/volumes/{" + KEY_VOLUME_UUID + "}/snapshots/{snapshot-uuid}/":                                 s.doVolumeList,
			...
			"/objectstores/{objectstore-uuid}/volumes/{" + KEY_VOLUME_UUID + "}/snapshots/{snapshot-uuid}/": s.doObjectStoreListVolume,
		},
		"POST": {
			...
			"/objectstores/{objectstore-uuid}/volumes/{" + KEY_VOLUME_UUID + "}/snapshots/{snapshot-uuid}/backup":  s.doSnapshotBackup,
			"/objectstores/{objectstore-uuid}/volumes/{" + KEY_VOLUME_UUID + "}/snapshots/{snapshot-uuid}/restore": s.doSnapshotRestore,
		...
		"DELETE": {
			...
			"/volumes/{" + KEY_VOLUME_UUID + "}/snapshots/{snapshot-uuid}/":                                 s.doSnapshotDelete,
			...
			"/objectstores/{objectstore-uuid}/volumes/{" + KEY_VOLUME_UUID + "}/snapshots/{snapshot-uuid}/": s.doSnapshotRemove,
